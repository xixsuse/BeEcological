...
public class RegisterUnloadView implements Initializable {
	...
	String invalidUnload = "Invalid unload registration.";
	...
	public void setRowSelected(MouseEvent event) {
		...
		if (event.getButton().equals(MouseButton.PRIMARY)) {
			...
			text_date.setValue(LocalDate.parse(booking.getBbDate(), DateTimeFormatter.ofPattern(dateFormat)));
	...
	public void confirmRegistrationUnload(ActionEvent event) {
		...
		if(user.getUsbUsername().equals(user_selected) && date.format(DateTimeFormatter.ofPattern(dateFormat)).equals(date_selected) && time.equals(hour_selected )) {
